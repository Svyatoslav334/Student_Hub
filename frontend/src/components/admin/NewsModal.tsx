...
const NewsModal = ({ isOpen, onClose, onSuccess, initialData }: any) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-[900px] max-w-[95%] bg-slate-900 border border-slate-800 rounded-3xl card-hover animate-fade-in modal-enter shadow-2xl overflow-hidden">
